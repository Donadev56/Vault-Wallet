...
class CustomInternalMaterialIndicator extends StatefulWidget {
  ...
  final double width;
  final double height;
  const CustomInternalMaterialIndicator({
    super.key,
    required this.child,
  ...
  const CustomInternalMaterialIndicator.adaptive({
    super.key,
    required this.child,
    required this.onRefresh,
    this.indicatorBuilder,
  ...
  @override
  State<CustomInternalMaterialIndicator> createState() =>
      _CustomInternalMaterialIndicator();
}

class _CustomInternalMaterialIndicator
    extends State<CustomInternalMaterialIndicator> {
  ...
  @override
  void didUpdateWidget(covariant CustomInternalMaterialIndicator oldWidget) {
