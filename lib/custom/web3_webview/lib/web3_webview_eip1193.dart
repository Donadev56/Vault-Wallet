...
class Web3WebView extends StatefulHookConsumerWidget {
  ...
  final Future<void> Function(int) onChangeNetwork;
...
class InAppWebViewEIP1193State extends ConsumerState<Web3WebView> {
  ...
  Future<void> _loadWeb3() async {
    try {
      String? web3;
      String path = 'assets/web3/ethers.min.js';
              ...
              controller.addJavaScriptHandler(
                ...
                callback: (args) async {
                  ...
                  try {
                    ...
                    if (JsonRpcMethod.fromString(method) ==
                        JsonRpcMethod.WALLET_SWITCH_ETHEREUM_CHAIN) {
                      if (params?.isNotEmpty == true) {
                        final newChainId = params?.first['chainId'];
                        await widget.onChangeNetwork(int.parse(newChainId));
                      }
                    }
