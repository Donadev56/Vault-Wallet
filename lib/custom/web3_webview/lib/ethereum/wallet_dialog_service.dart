...
class WalletDialogService {
  ...
  Future<bool?> showTransferConfirm(
    BuildContext context, {
    required TransferData transferData,
    required AppColors colors,
  }) async {
    final String from = transferData.account.address;
    final String to = transferData.to;
    final value = transferData.amountInEth;
    final gas = transferData.gas;
        ...
        children: [
            ...
            _buildContainer(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(transferData.crypto.symbol.toUpperCase(),
                        style: GoogleFonts.roboto(
                            color: colors.textColor.withOpacity(0.3),
                            fontSize: 21,
                            fontWeight: FontWeight.bold))
          ...
          if (gas != null)
            _buildContainer(
              ...
              colors: colors,
              child:
                  _buildInfoRow('Estimated Fee', gas.toString(), false, colors),
            ),
          SizedBox(height: _theme.itemSpacing * 2),
          _buildActionButtons(
            colors: colors,
