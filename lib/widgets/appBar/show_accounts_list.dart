...
void showAccountList({
  ...
  showFloatingModalBottomSheet(
      ...
      builder: (BuildContext modalCtx) {
        return StatefulBuilder(builder: (BuildContext context, setModalState) {
          return Consumer(builder: (ctx, ref, child) {
            ...
            Future<bool> deleteWallet(String walletId) async {
              try {
                ...
                if (password.isNotEmpty) {
                  ...
                  final deleteResult =
                      await accountsProvider.deleteWallet(accountToRemove);
                  if (deleteResult) {
            ...
            Future<bool> editWallet(
                ...
                String? name}) async {
              try {
                final result = await accountsProvider.editWallet(
                  account: account,
                  name: name,
                  icon: icon,
                  color: color,
                                                              ...
                                                              onMoreTap:
                                                                ...
                                                                try {
                                                                  showAccountOptions(
                                                                    ...
                                                                    colors:
                                                                        colors,
                                                                    availableAccounts: filteredList(
                                                                        query:
                                                                            searchQuery,
                                                                        accts:
                                                                            accounts),
