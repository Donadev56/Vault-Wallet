...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> options = [
      {'icon': LucideIcons.pencil, 'name': 'Edit', 'color': textColor},
      {'icon': LucideIcons.trash, 'name': 'Delete', 'color': Colors.pinkAccent},
      {'icon': LucideIcons.copy, 'name': 'Copy', 'color': textColor},
    ];
    return AppBar(
                            ...
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext ctx, int index) {
                                    final currentWallet = accounts[index];
