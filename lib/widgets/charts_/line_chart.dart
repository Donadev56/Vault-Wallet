...
class CustomLineChart extends StatelessWidget {
  ...
  const CustomLineChart(
      ...
      this.borderData,
      this.symbol = "\$",
      this.tooltipRoundedRadius = 2,
      this.flDotCirclePainterRadius = 6,
      this.shadowRadius = 4,
      this.shadowColor = Colors.transparent,
      this.barWidth = 2,
      this.maxScale = 25,
      this.minScale = 1,
      this.flLineStrokeWidth = 1,
      this.touchSpotThreshold = 5,
      this.enableToCallBack = true,
          ...
          getTouchedSpotIndicator:
            ...
            return spotIndexes.map((spotIndex) {
              return TouchedSpotIndicatorData(
                FlLine(
                  color: !isPositive ? colors.redColor : colors.themeColor,
                ...
                FlDotData(
                  ...
                  getDotPainter: (spot, percent, barData, index) {
                    return FlDotCirclePainter(
                      ...
                      strokeWidth: 0,
                      strokeColor:
                          isPositive ? colors.themeColor : colors.redColor,
                    );
                  },
                ),
              );
          ...
          touchTooltipData: LineTouchTooltipData(
            ...
            getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
              return touchedBarSpots.map((barSpot) {
                ...
                final date = chartData![barSpot.x.toInt()].$1;
            ...
            getTooltipColor: (LineBarSpot barSpot) => colors.secondaryColor,
          ),
        ),
