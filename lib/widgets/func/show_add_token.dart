...
void showAddToken ({required BuildContext context, required AppColors colors, required double width , required List<Crypto> reorganizedCrypto , required PublicData currentAccount , required bool hasSaved}) {
                                            ...
                                            shape: RoundedRectangleBorder(
                                              ...
                                              builder: (ctx) {
                                                return SingleChildScrollView(
                                                  child: Column(
                                                    children: List.generate(reorganizedCrypto
                                                        .where((crypto) =>
                                                            crypto.type ==
                                                            CryptoType.network).length + 1, (index) {
...
;
                                                        ...
                                                        .where((crypto) =>
                                                            crypto.type ==
                                                            CryptoType.network).toList()[index - 1];
                                                              return  ListTile(
                                                        leading: ClipRRect(
                                                          borderRadius:
                                                              BorderRadius
