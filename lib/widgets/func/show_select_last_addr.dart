...
void showSelectLastAddr ({required BuildContext context ,required PublicDataManager publicDataManager,required PublicData currentAccount, required AppColors colors , required TextEditingController addressController , required Crypto currentNetwork}) {
                                    ...
                                    Future<List<dynamic>> getAddress() async {
                                      try {
                                        ...
                                        if (lastUsedAddresses != null) {
                                          return (json.decode(lastUsedAddresses) as List<dynamic>).toSet().toList();
                                        } else {
                                          return [];
                                        }
                                      } catch (e) {
